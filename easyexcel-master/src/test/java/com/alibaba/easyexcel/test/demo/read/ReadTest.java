...
public class ReadTest {
 ...
 /*       // 写法2：
    ...
    public void readOrder() {
        OrderDataDao dao = new OrderDataDao();
        String fileName = TestFileUtil.getPath() + "demo" + File.separator + "order.xlsx";
        EasyExcel.read(fileName, OrderDataVo.class, new OrderDataListener(dao)).sheet().doRead();
    }
